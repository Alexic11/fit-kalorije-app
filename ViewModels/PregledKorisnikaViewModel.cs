...
{
    public class PregledKorisnikaViewModel :
        INotifyPropertyChanged
    {
        ...
        public Korisnik? SelektovaniKorisnik
        {
            ...
            set
            {
                ...
                OnPropertyChanged(
                    nameof(SelektovaniKorisnik));

                (IzmijeniCommand as RelayCommand)?
                    .RaiseCanExecuteChanged();

                (ObrisiCommand as RelayCommand)?
                    .RaiseCanExecuteChanged();
            }
        }
        ...
        public PregledKorisnikaViewModel()
        {
            ...
            DodajCommand =
                new RelayCommand(DodajKorisnika);
        ...
        private void DodajKorisnika()
        {
            ...
            var forma =
                new KorisnikFormaWindow(novi);

            if (forma.ShowDialog() == true)
            {
                /*
                 * Lozinka je već hashirana u
                 * KorisnikFormaWindow.
                 *
                 * Ovdje je NE hashiramo ponovo.
                 */
        ...
        private void IzmijeniKorisnika()
        {
            ...
            {
                IdKorisnik =
                    SelektovaniKorisnik.IdKorisnik,

                Ime =
                    SelektovaniKorisnik.Ime,

                Prezime =
                    SelektovaniKorisnik.Prezime,

                KorisnickoIme =
                    SelektovaniKorisnik.KorisnickoIme,

                // Postojeći hash ostaje ako admin
                // ne unese novu lozinku.
                Lozinka =
                    SelektovaniKorisnik.Lozinka,

                IdRole =
                    SelektovaniKorisnik.IdRole
            };

            var forma =
                new KorisnikFormaWindow(kopija);

            if (forma.ShowDialog() == true)
            {
                var original =
                    _context.Korisniks.Find(
                        kopija.IdKorisnik);
                ...
                if (original != null)
                {
                    ...
                    original.KorisnickoIme =
                        kopija.KorisnickoIme;
